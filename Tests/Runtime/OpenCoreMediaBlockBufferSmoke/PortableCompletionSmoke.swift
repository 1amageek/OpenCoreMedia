...
enum OpenCoreMediaPortableCompletionSmoke {
    static func verify() throws {
        ...
        let image = OpenCoreMediaPortablePixelBuffer(
            dimensions: dimensions
        )
        let imageSample = try CMImageSampleBuffer(
            imageBuffer: image,
        ...
        guard try imageSample.imageBuffer() === image else {
            throw OpenCoreMediaPortableCompletionSmokeError.contractViolated
        }
...
private final class OpenCoreMediaPortablePixelBuffer:
    CVPixelBuffer,
    Sendable
{
    ...
    let attachments = OpenCoreMediaPortablePixelAttachments()
...
private struct OpenCoreMediaPortablePixelAttachments:
